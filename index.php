						...
						<div class="card bg-secondary invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
										<?php
										$data_barang = mysqli_query($koneksi, "SELECT * from data_distributor_221013");
										$jumlah = mysqli_num_rows($data_barang);
										echo $jumlah;
										?>
									</h2>
									<span class="text-white fs-18">Total Distributor</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num">
										<?php
										$data_barang = mysqli_query($koneksi, "SELECT * from data_admin_221013");
										$jumlah = mysqli_num_rows($data_barang);
										echo $jumlah;
										?>
									</h2>
