            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Data merek</a></li>
                    </ol>
                </div>
                <div class="row">
                    <div class="col-12">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-outline-secondary" id="edits" data-bs-toggle="modal" data-bs-target="#editdata" data-id="<?php echo $row['id_merek_221013']; ?>" data-nama="<?php echo $row['nama_merek_221013']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                            </svg></button>
                                                        <button type="button" class="btn btn-outline-danger" id="hapus" data-bs-toggle="modal" data-bs-target="#hapusdata" data-id="<?php echo $row['id_merek_221013']; ?>" data-nama="<?php echo $row['nama_merek_221013']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title  fw-bold" id="deleteprojectLabel">Tambah Data Merek</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="tmerek" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-body justify-content-center flex-column d-flex">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Merek</label>
                                            <input type="text" id="uid" class="form-control" disabled hidden>
                                            <input type="text" id="umerek" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            function tambah() {
                ...
                if (merek == "") {
                    ...
                    $.ajax({
                        url: "controller/controller_merek.php",
                        type: "POST",
                        data: fd,
                        contentType: false,
                        processData: false,
                        success: function(response) {
                            ...
                            if (response === "sukses") {
                                swal.fire({
                                    ...
                                    if (isConfirm) {
                                        window.location.replace("data_merek.php");
                                    }
                                });
            ...
            $(document).on("click", "#hapus", function() {
                let id = $(this).attr("data-id");
                let merek = $(this).attr("data-nama");
                document.getElementById("tampil").innerHTML = merek;
                $('#hid').val(id);
            });
