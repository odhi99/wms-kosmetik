            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Data barang keluar</a></li>
                    </ol>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title  fw-bold" id="deleteprojectLabel">Barang Keluar</h5>
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="modal-body justify-content-center flex-column d-flex">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Stok Keluar</label>
        ...
        <script type="text/javascript">
            ...
            function tambah() {
                ...
                if (barang == "" || stok == "") {
                    ...
                    $.ajax({
                        url: "controller/user/controller_keluar.php",
                        type: "POST",
                        data: fd,
                        contentType: false,
                        processData: false,
                        success: function(response) {
                            ...
                            if (response === "sukses") {
                                swal.fire({
                                    ...
                                    if (isConfirm) {
                                        window.location.replace("data_barang_keluar.php");
                                    }
                                });
