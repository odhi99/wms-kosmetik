                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            require 'controller/koneksi.php';
                                            $result = mysqli_query($koneksi, "SELECT * FROM data_admin_221013");
                                            $i = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $row['username_admin_221013']; ?></td>
                                                    <td>
                                                        <?php
                                                        if ($row['level_admin_221013'] == 1) {
                                                            echo '<span class="text-warning">Admin</span>';
                                                        } else {
                                                            echo '<span class="text-primary">Karyawan</span>';
                                                        }

                                                        ?>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-outline-secondary" id="edits" data-bs-toggle="modal" data-bs-target="#editdata" data-id="<?php echo $row['id_admin_221013']; ?>" data-nama="<?= $row['nama_admin_221013']; ?>" data-username="<?= $row['username_admin_221013']; ?>" data-pass="<?= $row['password_admin_221013']; ?>" data-level="<?= $row['level_admin_221013']; ?>" "><svg xmlns=" http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                            </svg>
                                                        </button>
                                                        <button type="button" class="btn btn-outline-danger" id="hapus" data-bs-toggle="modal" data-bs-target="#hapusdata" data-id="<?php echo $row['id_admin_221013']; ?>" data-nama="<?php echo $row['nama_admin_221013']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
        ...
        ***********************************-->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title  fw-bold" id="deleteprojectLabel">Tambah Data User</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form method="POST" enctype="multipart/form-data" htmlspecialchars>
                            <div class="modal-body justify-content-center flex-column d-flex">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Username</label>
                                            <input type="text" id="tusername" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Password</label>
                                            <input type="password" id="tpass" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Level</label>
            ...
            <div class="modal fade" id="editdata" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title  fw-bold" id="deleteprojectLabel">Edit Data User</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                            ...
                            <div class="modal-body justify-content-center flex-column d-flex">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Username</label>
                                            <input type="text" id="uusername" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
    ...
    ***********************************-->
        ...
        <script type="text/javascript">
            ...
            function tambah() {
                ...
                let pass = $('#tpass').val();
                let level = $('#tlevel').val();
                let pilih = 1;
                if (nama == "" || pass == "" || username == "") {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response === "sukses") {
                                ...
                                Swal.fire('', 'User telah terdaftar', 'error');
                            } else {
                                alert("Gagal input !");
                            }
                        },
