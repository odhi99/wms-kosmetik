                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a type="button" class="btn btn-outline-primary" href="print_keluar.php"><i class="flaticon-072-printer"></i> PRINT</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            require 'controller/koneksi.php';
                                            $result = mysqli_query($koneksi, "SELECT * FROM data_barang_keluar_221013 join data_barang_221013 join data_admin_221013 on data_barang_keluar_221013.id_barang_221013 = data_barang_221013.id_barang_221013 and data_admin_221013.id_admin_221013 = data_barang_keluar_221013.id_admin_221013");
                                            $i = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $row['jumlah_keluar_221013']; ?></td>
                                                    <td><?= $row['tgl_keluar_221013']; ?></td>
