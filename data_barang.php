...
<body>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            require 'controller/koneksi.php';
                                            $result = mysqli_query($koneksi, "SELECT * FROM data_barang_221013 JOIN data_type_221013 JOIN data_merek_221013 on data_barang_221013.id_merek_221013 = data_merek_221013.id_merek_221013 AND data_barang_221013.id_type_221013 = data_type_221013.id_type_221013");
                                            $i = 1;
                                            while ($row = mysqli_fetch_array($result)) {
                                            ?>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><?= $row['nama_barang_221013']; ?></td>
                                                    <td><?= $row['nama_merek_221013']; ?></td>
                                                    <td><?= $row['nama_type_221013']; ?></td>
                                                    <td><?= $row['stok_barang_221013']; ?></td>
                                                    <td> <img src="img/data_barang/<?= $row['foto_221013']; ?>" class="img-thumbnail" width="70" alt=""></td>
                                                    <td>
                                                        <button type="button" class="btn btn-outline-secondary" id="edits" data-bs-toggle="modal" data-bs-target="#editdata" data-id="<?php echo $row['id_barang_221013']; ?>" data-merek="<?php echo $row['id_merek_221013']; ?>" data-type="<?php echo $row['id_type_221013']; ?>" data-nama-type="<?= $row['nama_type_221013']; ?>" data-nama="<?php echo $row['nama_barang_221013']; ?>" data-stok="<?php echo $row['stok_barang_221013']; ?>" data-foto="<?php echo $row['foto_221013']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                            </svg></button>
                                                        <button type="button" class="btn btn-outline-danger" id="hapus" data-bs-toggle="modal" data-bs-target="#hapusdata" data-id="<?php echo $row['id_barang_221013']; ?>" data-nama="<?php echo $row['nama_barang_221013']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
        ...
        ***********************************-->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title  fw-bold" id="deleteprojectLabel">Tambah Data Barang</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Nama Barang</label>
                                            <input type="text" id="tbarang" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Pilih Merek</label>
                                            <select id="tmerek" class="form-control">
                                                <option selected>--pilih--</option>
                                                <?php
                                                $result = mysqli_query($koneksi, "select * from data_merek_221013");
                                                while ($row = mysqli_fetch_array($result)) {
                                                ?>
                                                    <option value="<?= $row['id_merek_221013']; ?>"><?= $row['nama_merek_221013']; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Pilih Type</label>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Stok</label>
                                            <input type="number" id="tstok" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Foto</label>
                                            <input type="file" id="tfoto" class="form-control" onchange="return validasiFile()">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-2" id="pratinjauGambar"></div>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="editdata" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title  fw-bold" id="deleteprojectLabel">Edit Data Merek</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form method="POST" enctype="multipart/form-data">
                            <div class="modal-body justify-content-center flex-column d-flex">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="ubarang" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Pilih Merek</label>
                                            <select id="umerek" class="form-control">
                                                <?php
                                                $result = mysqli_query($koneksi, "select * from data_merek_221013");
                                                while ($row = mysqli_fetch_array($result)) {
                                                ?>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Stok</label>
                                            <input type="number" id="ustok" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3" id="pratinjauGambar2"></div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="text-input2" class="form-label">Ubah Foto</label>
                                            <input type="file" id="ufoto" class="form-control" onchange="return validasiFile1()">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-2" id="pratinjauGambar1"></div>
                                </div>
                            </div>
                            <div class="modal-footer justify-content-center">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
    ...
    ***********************************-->
        ...
        <script type="text/javascript">
            $('#tmerek').change(function() {
                var merek = $(this).val();
                $.ajax({
                    type: 'POST',
                    url: 'controller/pilih.php',
                    data: 'id_merek_221013=' + merek,
            ...
            $('#umerek').change(function() {
                var merek = $(this).val();
                $.ajax({
                    type: 'POST',
                    url: 'controller/pilih1.php',
                    data: 'id_merek=' + merek,
                    success: function(response) {
                        $('#utype').html(response);
                    }
                ...
                if (!ekstensiOk.exec(pathFile)) {
                    ...
                    if (inputFile.files && inputFile.files[0]) {
                        ...
                        reader.onload = function(e) {
                            document.getElementById('pratinjauGambar').innerHTML = '<img class="img-thumbnail" src="' + e.target.result + '"/>';
                        };
            ...
            function validasiFile1() {
                ...
                if (!ekstensiOk.exec(pathFile)) {
                    ...
                    if (inputFile.files && inputFile.files[0]) {
                        var reader = new FileReader();
                        reader.onload = function(e) {
                            document.getElementById('pratinjauGambar1').innerHTML = '<img class="img-thumbnail" src="' + e.target.result + '"/>';
                        };
                        reader.readAsDataURL(inputFile.files[0]);
                    }
                }
        ...
        <script type="text/javascript">
            // tambah data
            function tambah() {
                let kosmetik = $('#tbarang').val();
                let merek = $('#tmerek').val();
                let type = $('#ttype').val();
                let stok = $('#tstok').val();
                let foto = $('#tfoto').val();
                ...
                if (merek == "" || kosmetik == "" || type == "" || stok == "" || foto == "") {
                    Swal.fire('', 'field tidak boleh kosong', 'error');
                } else if (!files) {
                    Swal.fire('', 'Silakan pilih file untuk diupload', 'error');
                } else {
                    let fd = new FormData();
                    fd.append('merek', merek);
                    fd.append('kosmetik', kosmetik);
                    fd.append('type', type);
                    fd.append('stok', stok);
                    ...
                    $.ajax({
                        url: "controller/controller_barang.php",
                        type: "POST",
                        data: fd,
                        contentType: false,
                        processData: false,
            ...
            $(document).on("click", "#edits", function() {
                ...
                let barang = $(this).attr("data-nama");
                let merek = $(this).attr("data-merek");
                let type = $(this).attr("data-type");
                let stok = $(this).attr("data-stok");
                let foto = $(this).attr("data-foto");
                let nmtype = $(this).attr("data-nama-type");

                $('#uid').val(id);
                $('#ubarang').val(barang);
                $('#umerek').val(merek);
                $('#ustok').val(stok);
                document.getElementById('utype').innerHTML = '<option value="' + type + '">' + nmtype + '</option>';
                document.getElementById('pratinjauGambar2').innerHTML = '<img class="img-thumbnail" src="img/data_barang/' + foto + '">';
            });


            function updatedata() {
                let barang = $('#ubarang').val();
                let merek = $('#umerek').val();
                let type = $('#utype').val(); // Pastikan ini berisi id_type, bukan nama tipe
                let stok = $('#ustok').val();
                let foto = $('#ufoto').val();
                ...
                if (merek == "" || barang == "" || type == "" || stok == "") {
                    ...
                    fd.append('merek', merek);
                    fd.append('type', type); // Pastikan id_type dikirim
                    fd.append('stok', stok);
                    fd.append('foto', files);
            ...
            $(document).on("click", "#hapus", function() {
                let id = $(this).attr("data-id");
                let barang = $(this).attr("data-nama");
                document.getElementById("tampil").innerHTML = barang;
                $('#hid').val(id);
            });
